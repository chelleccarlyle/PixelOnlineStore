...
<div class="container">
	...
	<form action="EditStoreItem" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="name" name="name" value="${currentItem.name}" placeholder="Enter the name of the item">
		</div>
		...
		<div class="form-group">
			...
			<textarea class="form-control" rows="3" id="description" name="description" placeholder="Enter the description of the item">${currentItem.description}</textarea>
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="quantity" name="quantity" value="${currentItem.quantity}">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="price" name="price" value="${currentItem.price}">
		</div>
